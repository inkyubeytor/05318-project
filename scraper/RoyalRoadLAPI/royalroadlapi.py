...
def get_chapter_link_list(fiction_id,start_chapter="first",end_chapter="last"): #download a fiction by id or search
    ...
    start_chapter, end_chapter, _ = get_chapter_range(start_chapter, end_chapter)
    chapter_links_approved = chapter_links[start_chapter:end_chapter]
    return chapter_links_approved
